...
{
    class WerewolfBloodlustPro
    {
        public static string IDName = "BloodlustUpgradePro";
                    ...
                    new CharacterTriggerDataBuilder
                    {
                        ...
                        EffectBuilders = new List<CardEffectDataBuilder>
                        {
                            new CardEffectDataBuilder
                            {
                                ...
                                ParamInt = 0,
                                ParamStatusEffects = new StatusEffectStackData[] { new StatusEffectStackData { statusId= "MeleeWeakness", count=3} },
