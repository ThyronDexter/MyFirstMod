...
{
    class WerewolfBloodlustPremium
    {
        public static string IDName = "BloodlustUpgradePremium";
                    ...
                    new CharacterTriggerDataBuilder
                    {
                        ...
                        EffectBuilders = new List<CardEffectDataBuilder>
                        {
                            new CardEffectDataBuilder
                            {
                                ...
                                ParamInt = 0,
                                ParamStatusEffects = new StatusEffectStackData[] { new StatusEffectStackData { statusId= "MeleeWeakness", count=2} },
